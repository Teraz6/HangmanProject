"""
hangman_images listi sisu peaks olema järgmine:
hangman_images[0]: Poomispuu koos ripatsiga
hangman_images[1]: Poomispuu koos ripatsiga ja peaga
hangman_images[2]: Poomispuu koos ripatsiga, pea ja kehaga
hangman_images[3]: Poomispuu koos ripatsiga, pea, keha ja ühe käega
hangman_images[4]: Poomispuu koos ripatsiga, pea, keha ja mõlema käega
hangman_images[5]: Poomispuu koos ripatsiga, pea, keha, mõlema käega ja ühe jalaga
hangman_images[6]: Poomispuu koos ripatsiga, pea, keha, mõlema käega ja mõlema jalaga (mängija on "poositud")
"""
...
def update_hangman_image(hangman_image_on_canvas=None, game_display=None): 
    game_display.itemconfig(hangman_image_on_canvas, 
                            image = hangman_images[wrong_guesses])

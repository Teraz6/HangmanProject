...
class GamePage(tk.Frame):
    def __init__(self, parent, controller, word_list=None):
        ...
        # --- CANVAS FOR HANGMAN IMAGE ---
        self.canvas = tk.Canvas(self, width=300, height=300)
        self.canvas.pack(pady=10)
        self.hangman_image = None  # Koht, kuhu pilt salvestada
    ...
    def on_show_frame(self, event):
        ...
        self.update_hangman_image() # Proovi see siia lisada
    ...
    def display_guess(self):
        ...
        if guess not in self.chosen_word:
            ...
            self.update_hangman_image() # Ja proovi see ka siia lisada
